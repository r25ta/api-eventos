  ...
  implements RowMapper<ViagemModel>
{
  public ViagemModel mapRow(ResultSet rs, int rowNum) throws SQLException {
    ...
    oViagem.setDhrPosicUlt(rs.getTimestamp("dhr_Posic_Ult"));
    ...
    oViagem.setDhrInclu(rs.getTimestamp("dhr_Inclu"));
    ...
    oViagem.setDhrAtviePln(rs.getTimestamp("dhr_Atvie_Pln"));
    oViagem.setCodAtvieUsu(rs.getString("cod_Atvie_Usu"));
    oViagem.setDhrPosicPrm(rs.getTimestamp("dhr_Posic_Prm"));
