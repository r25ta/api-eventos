...
import br.com.pamcary.api.evento.exception.RoteiroNotFoundException;
...
public class RoteiroViagemDAOImpl extends JdbcDaoSupport implements RoteiroViagemDAO {
	...
	public List<RoteiroViagemModel> getByEventosPorDestino(long ctlPlvia) {
		...
		try{
			...
			throw new RoteiroNotFoundException("Erro na execução! " + SQL_ROTEIRO_VIAGEM + WHERE_EVENTOS_REALIZADOS_POR_VIAGEM + ORDER_BY_EVENTOS_ASC +" Causa do Erro -> ",e);
