...
public class UsuarioDAOImpl extends JdbcDaoSupport implements UsuarioDAO {
	...
	public User getUserByName(String userName) {
		...
		try {
			...
			throw new ViagemNotFoundException("Erro na execução! " + SQL_BUSCA_USUARIO +" Causa do Erro -> "+ e);
		}
	...
	public UsuarioModel getUsuarioByOperacao(String nomUser, int ctlOperaTip) {
		...
		try {
			...
			throw new ViagemNotFoundException("Erro na execução! " + SQL_BUSCA_USUARIO_ATIVO_NA_OPERACAO +" Causa do Erro -> "+ e);
		}
