...
public class ViagemDTO {
	...
	public String toString() {
		return "ViagemDTO [ctlPlvia=" + this.ctlPlvia + ", ctlOperatip=" + this.ctlOperatip + ", desOperaTip="
				...
				+ ", qtdDistaTot=" + this.qtdDistaTot + ", numSinis=" + this.numSinis + ", semEventos="
				+ this.semEventos + ", desOperaVie=" + this.desOperaVie + ", desTipRast=" + this.desTipRast
				+ ", desPlvia=" + this.desPlvia + ", eventos=" + this.eventos + ", motoristas=" + this.motoristas
				+ ", veiculos=" + this.veiculos + ", dispositivoCompl=" + this.dispositivoCompl + ", tecnologiaCompl="
